...
const Home = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#222328] text-[32px]">From Our Community</h1>
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">Check out stunning creations from our community. Take Inspiration or Use in your Works.</p>
      </div>
      <div className="mt-16">
        <FormField 
